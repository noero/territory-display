...
function onMapLoad() {
    ...
    kindSelector.change(function (event) {
        ...
        if (map.getLayer('territoire-borders')) map.removeLayer('territoire-borders');
        if (map.getLayer('territoire-numbers')) map.removeLayer('territoire-numbers');
        if (map.getSource('territoire')) map.removeSource('territoire');
        if (map.getLayer('territoire-found-border')) map.removeLayer('territoire-found-border');
